...
saveRDS(rf_enet_under, file = "models/rf_enet_rose.rds")
...
saveRDS(gbm_enet_under, file = "models/gbm_enet_rose.rds")
```
...
rf_enet_over <- read_rds("models/rf_enet_under.rds")

p_rf_eu <- predict(rf_enet_under, test, type = "prob")
```
