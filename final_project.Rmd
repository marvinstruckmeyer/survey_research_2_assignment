...
country_comp$pred <- p_rf_s    # create new column of predictions from GBM (using synthetic data generation)
...
full_pred <- predict(gbm_smote, full_data) # Prediction using GBM synthetic data
